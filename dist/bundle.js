...
var _meta_tags_context = __webpack_require__(82);

var _meta_tags_context2 = _interopRequireDefault(_meta_tags_context);

var _meta_tags = __webpack_require__(39);

var _meta_tags2 = _interopRequireDefault(_meta_tags);

var _react_title = __webpack_require__(84);
...
exports.HomeListDetail = exports.HomeHeader = exports.HomeListMedia = exports.HomeButton = undefined;
...
var HomeButton = exports.HomeButton = function HomeButton(_ref) {
		var data = _ref.data;
...
var HomeListMedia = exports.HomeListMedia = function HomeListMedia(_ref2) {
		var data = _ref2.data;
		return _react2.default.createElement('img', { src: data.image, alt: data.title });
};

var HomeHeader = exports.HomeHeader = function HomeHeader() {

		return _react2.default.createElement(
				'div',
				{ className: 'header' },
				_react2.default.createElement('img', { src: 'src/image/header.jpg' })
		);
};

var HomeListDetail = exports.HomeListDetail = function HomeListDetail(props) {
		var data = props.data;


		return _react2.default.createElement(
				'div',
				{ className: 'row list-elem' },
				_react2.default.createElement(
						'div',
						{ className: 'col-4' },
						_react2.default.createElement(HomeListMedia, props)
				),
				_react2.default.createElement(
						'div',
						{ className: 'col-8' },
						...
						_react2.default.createElement(HomeButton, props)
				)
		);
};
;
...
var _Singlepage = __webpack_require__(89);
...
var HomeList = exports.HomeList = function HomeList(list) {

  var list = _data.content_data;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      null,
      _react2.default.createElement(_Home.HomeHeader, null)
    ),
    _react2.default.createElement(
      'div',
      { className: 'container' },
      list.map(function (data) {
        return _react2.default.createElement(_Home.HomeListDetail, { data: data, key: data.id });
      })
    )
  );
};
...
var Contact = exports.Contact = function Contact() {
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ className: 'col-8 col-m-12' },
				_react2.default.createElement(
					'h3',
					null,
					'Jakie\u015B namiary na mnie'
				),
				_react2.default.createElement(
					'p',
					null,
					'Email: biuro@seojoker.pl'
				),
				_react2.default.createElement(
					'p',
					null,
				...
				_react2.default.createElement(
					'p',
					null,
					_react2.default.createElement('iframe', { src: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1280.1512922833379!2d19.971573171982683!3d50.08062144371267!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47165bcc27d7e555%3A0x979ebcdbb8b80d29!2sGrupa+Onet.pl!5e0!3m2!1spl!2spl!4v1517900229759', width: 600, height: 450, frameBorder: 0, style: { border: 0 }, allowFullScreen: true })
				)
			)
		)
	);
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement('img', { src: 'src/image/haincz.jpg' })
			),
			_react2.default.createElement(
				'div',
				{ className: 'col-8 about-content col-m-12' },
				_react2.default.createElement(
					'h3',
					null,
					'Siedze w SEO tyle lat, \u017Ce najch\u0119tniej bym tym pierdoln\u0105\u0142 i ruszy\u0142 w Bieszczady'
				),
				_react2.default.createElement(
					'p',
					null,
					'Nazywam si\u0119 Mateusz Miko\u015B i zajmuje si\u0119 SEO - no i to by by\u0142o na tyle. Kiedy\u015B dawno temu, gdy pisa\u0142em o grach i odpowiada\u0142em za redakcj\u0119 serwisu, mia\u0142em lekkie pi\xF3ro i g\u0142ow\u0119 pe\u0142n\u0105 kwiecistych por\xF3wna\u0144 i metafor. Teraz gdy zajmuje si\u0119 SEO, a raczej jego techniczn\u0105 stron\u0105, moje metafory i por\xF3wnania sp\u0142aszczone zosta\u0142y do najpopularniejszych polskich przerywnik\xF3w i wielokrotnych wariacji na ich temat.'
				),
				_react2.default.createElement(
					'p',
					null,
					'W grupie Onet-RASP jestem Team Leaderem i osob\u0105 odpowiedzialn\u0105 za kwestie technologiczne, czyli krzycz\u0119, narzekam, marudz\u0119, czepiam si\u0119 i d\u0142ubie. Prywatnie jestem spokojnym, zr\xF3wnowa\u017Conym i zdystansowanym do siebie m\u0119\u017Cem i ojcem dw\xF3jki dzieci, kt\xF3ry w nocy, gdy wszyscy ju\u017C \u015Bpi\u0105, strzela na strychu z \u0142uku\u2026'
				)
			)
		)
	);
...
var SinglePage = exports.SinglePage = function SinglePage(_ref) {
...
var Sidebar = exports.Sidebar = function Sidebar() {
	...
	return _react2.default.createElement(
		'aside',
		{ className: 'sidebar col-4 col-m-12' },
